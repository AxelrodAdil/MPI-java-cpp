...
int main(int argc, char** argv) {
    ...
    char a[ROWS * COLS];
    const int NPROWS = 2;  /* number of rows in decomposition */
    const int NPCOLS = 2;  /* number of cols in decomposition */
    const int BLOCKROWS = ROWS / NPROWS;  /* number of rows in block */
    const int BLOCKCOLS = COLS / NPCOLS; /* number of cols in block */
